...
export const CARD_STORIES={
 discovery:'Le premier horizon',explorer:'Les portes du monde',heir:'Les racines de l’héritage',ambassador:'Le collectif sans frontières',legend:'Le monde couronné'
};
...
export function memberCardSvg(profile,tier=TIERS[0],{transparent=false,artworkDataUrl}={}){
 ...
 <rect x="994" y="47" width="154" height="51" rx="24" fill="#071015" fill-opacity=".75" stroke="${accent}" stroke-opacity=".5"/><text x="1071" y="79" text-anchor="middle" fill="#f7dfad" font-family="Arial,sans-serif" font-size="16" letter-spacing="3">${String(TIERS.indexOf(t)+1).padStart(2,'0')} / 05</text>
 ...
 <text x="56" y="655" font-size="10" letter-spacing="2.5" opacity=".8">TITULAIRE · MEMBRE ${escape(id)}</text><text x="56" y="691" font-size="${Math.max(17,Math.min(24,850/name.length))}" letter-spacing="1.5" fill="#fff6e7">${escape(name)}</text><text x="925" y="654" font-size="11" letter-spacing="2">CARTE DIGITALE 3B</text><text x="925" y="688" font-size="9" letter-spacing=".5">PAS UN MOYEN DE PAIEMENT</text></g></g></svg>`;
}
