...
export function rotatedFootprint(building,rotation=0){const fp=building?.footprint||{};let w=Math.max(1,Math.min(20,Number(fp.w)||1)),h=Math.max(1,Math.min(20,Number(fp.h)||1));if(Number(rotation)%180!==0)[w,h]=[h,w];return{w,h}}
