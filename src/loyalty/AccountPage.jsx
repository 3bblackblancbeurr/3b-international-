...
import {COUNTRIES,accountEmail,validateAccount,themeFor} from '../../shared/loyalty.js';
...
export default function AccountPage({legacy,options,toggleOption,goTo}){
 ...
 const[mode,setMode]=useState('login'),[fields,setFields]=useState({handle:'',password:'',name:legacy?.name||'',country:legacy?.originCountry||'France',recovery:''}),[error,setError]=useState(''),[busy,setBusy]=useState(false),[recovery,setRecovery]=useState('');
