...
export default function ArenaPage({onAccount,onExit}){
 ...
 return <div ref={root} className={'card-arena'+(fighting?' is-fighting':'')}>
  ...
  {fighting?<>
   ...
   <div className="arena-intro"><span className="arena-seal">3B</span><div><h3>Trois compagnons. Un lien à défendre.</h3><p>Fais entrer tes personnages dans l’arène. Alterne attaques, pouvoirs et réserves pour épuiser les trois adversaires.</p></div></div>
   {!user&&<div className="arena-account"><p>Connecte ton compte 3B pour retrouver tes compagnons et affronter d’autres joueurs sur Internet.</p><button className="arena-primary" onClick={onAccount}>Se connecter au compte 3B</button></div>}
   ...
   <details className="arena-rules"><summary>Règles et progression</summary><p>Trois personnages distincts et au plus un personnage de l’Union. Les huit compagnons d’initiation et quelques équipements sont prêtés dans l’arène. Tes autres compagnons se rencontrent dans le Monde 3B.</p><p>Chaque tour dure 45 secondes. Un changement de combattant consomme le tour et accorde 8 points de bouclier. Les rôles ont des statistiques fixes : la rareté, les achats, la nationalité et la maîtrise ne donnent aucun avantage de puissance.</p><p>Classé : +16 de cote en victoire, −16 en défaite. Après au moins 6 actions, chaque membre de ton équipe gagne 30 XP de maîtrise en victoire ou 15 autrement, dans la limite de 20 duels récompensés par jour. La maîtrise débloque un niveau honorifique.</p><p>Après au moins 12 actions et 90 secondes, un duel terminé rapporte aussi 40 XP de compte en victoire ou 20 autrement, plus 1 point de fidélité. Ces gains respectent le plafond commun des jeux : 600 XP et 20 points par jour. Seuls les trois premiers duels de la journée contre la même personne peuvent rapporter ce bonus. L’entraînement ne distribue aucune récompense. Aucun jeton blockchain n’est émis.</p><p>Un tournoi réunit quatre joueurs ; les deux vainqueurs disputent la finale. Après 100 actions, la vitalité restante départage les équipes. Une égalité parfaite en tournoi favorise la première tête de série annoncée dans le tableau.</p></details>
  </>}
