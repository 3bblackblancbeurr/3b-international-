...
import {createPremiumHubPlatform} from './hub/premium-platform.js';
...
export function createLandscape(models,region,save,onError=console.error){
 ...
 let heritage=null,premiumHub=null,qualityMode='auto';const qualityGroups=[];const genericBuildings=new THREE.Group();root.add(genericBuildings);
 ...
 if(hub){
  ...
  qualityGroups.push(...premiumHub.qualityGroups);
 }else{
