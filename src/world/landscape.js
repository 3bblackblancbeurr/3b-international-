...
export function createLandscape(models,region,save,onError=console.error){
 ...
 const meadow=addMeadow(field,root,owned,region),microDetails=addPremiumMicroDetails({region,field,root,owned}),reduceWind=typeof window!=='undefined'&&window.matchMedia('(prefers-reduced-motion: reduce)').matches;
