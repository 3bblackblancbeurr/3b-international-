...
export function AvatarCinematic({avatar, onDone}) {
  const sequence = useMemo(() => characterSequence({avatar, power: AVATAR_PATHS[avatar.path], gear: TRAVEL_GEAR[avatar.travelGear]}), [avatar]);
