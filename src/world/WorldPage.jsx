...
function WorldSession({uid,goTo}){
 ...
 return <section ref={shell} className="world-shell" aria-label="Le Monde du 3B">
  ...
  {panel&&<Modal kind={panel} title={({collection:'Les compagnons du monde',sanctuary:'Un lieu pour ton groupe',team:'Ton équipe',atlas:'L’Atlas des huit portes',journal:'Journal d’exploration',gps:'Les échos du dehors',pause:'Une pause dans le voyage',encounter:'Un écho te rencontre',final:'L’Union retrouvée',story:'Un pays à reconstruire',wardrobe:'Ton style',avatar:'Ton personnage',arena:'L’Arène 3B'})[panel]} onClose={closePanel} wide={['collection','atlas','journal','avatar','arena'].includes(panel)}>
   ...
   {panel==='final'&&<div className="world-result"><Sparkles size={46}/><h3>Les huit pays vivent à nouveau.</h3><p>Tu as aidé leurs habitants, reconstruit leurs lieux et traversé l’Oubli. Leur lumière est maintenant réunie au Nexus.</p><p>Continue à rencontrer les habitants et les créatures, à développer leurs pouvoirs et à relever les défis experts.</p><button className="world-primary" onClick={()=>setPanel('wardrobe')}>Porter la tenue de l’Union</button></div>}
  </Modal>}
 </section>;
}
