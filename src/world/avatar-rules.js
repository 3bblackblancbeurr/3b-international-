...
export function normalizeAvatar(a){
 ...
 result.beard=Number.isInteger(a.beard)?Math.max(0,Math.min(6,a.beard)):'none';result.mustache=Number.isInteger(a.mustache)?Math.max(0,Math.min(4,a.mustache)):0;result.assetSlots=normalizeAvatarAssetSlots(a.assetSlots);
