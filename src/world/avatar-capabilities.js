...
export const BODY_CAPABILITIES=[
 {id:'shoulders',label:'Épaules',available:false,morphs:['ShouldersWide','ShouldersNarrow']},
 {id:'chest',label:'Torse',available:false,morphs:['ChestFull','ChestFlat']},
 {id:'waist',label:'Taille',available:false,morphs:['WaistWide','WaistNarrow']},
 {id:'hips',label:'Hanches',available:false,morphs:['HipsWide','HipsNarrow']},
 {id:'arms',label:'Bras',available:false,morphs:['ArmsThick','ArmsThin']},
 {id:'legs',label:'Jambes',available:false,morphs:['LegsThick','LegsThin']}
];
export const ACTIVE_BODY_CAPABILITIES=BODY_CAPABILITIES.filter(x=>x.available);
...
export function creatorCapabilities(){
 return {
  ...
  body:{available:ACTIVE_BODY_CAPABILITIES.map(x=>x.id),future:BODY_CAPABILITIES.filter(x=>!x.available).map(x=>x.id)},
