...
export const XP_REWARDS={discoverZone:20,discoverSecret:80,activateRelay:150,enterCountry:120,mainMission:450,sideMission:140,guardianMission:900,placeFirstBuilding:60,cityUpgrade:90,cityEvent:120,dailyReturn:25};
export const COIN_REWARDS={discoverSecret:15,mainMission:80,sideMission:25,guardianMission:180,cityEvent:35};
