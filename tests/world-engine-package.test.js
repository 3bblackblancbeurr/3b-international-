...
test('world-engine deployment pack includes nested Hub reducer dependencies',()=>{
 ...
 try{
  ...
  for(const name of ['hub/state.js','hub/mission-catalog.js','hub/mission-runtime.js','hub/activity-catalog.js','hub/secret-runtime.js','hub/mission-signals.js','hub/mission-graph.js','hub/dialogue-v3.js','hub/dialogue-intents.js','guardian-values.js','cinematic-events.js'])assert.ok(names.has(name),name);
...
test('authoritative world engine mirrors critical client gameplay reducers',()=>{
 const critical=['engine.js','rules.js','adventure-state.js','field-combat.js','guardian-values.js','hub/activity-catalog.js','hub/state.js','hub/mission-signals.js','hub/mission-runtime.js','hub/mission-catalog.js','hub/mission-graph.js','hub/dialogue-intents.js'];
