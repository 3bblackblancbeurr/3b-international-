...
test('the library keeps the original four games and adds DADA 3B as the fifth card',()=>{
 assert.deepEqual(GAME_CATALOG.map(g=>g.id),['arena','tower','maze','key-race','dada3b']);assert.equal(GAME_CATALOG[3].href,KEY_RACE_URL);
