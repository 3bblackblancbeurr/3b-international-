...
test('V7 brightens the board and reduces dark fog',()=>{
  assert.match(three,/toneMappingExposure=1\.42/);
  assert.match(three,/FogExp2\(0x061013,\.016\)/);
  assert.match(three,/HemisphereLight\(0xc8f7ff,0x2b1909,2\.35\)/);
  assert.match(three,/DirectionalLight\(0xffe6b0,5\.4\)/);
  assert.match(three,/PointLight\(0x58e7fb,24/);
});
