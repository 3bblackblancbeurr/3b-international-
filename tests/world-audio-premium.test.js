...
test('premium World audio exposes independent music ambience sfx voice controls',()=>{
 ...
 for(const name of ['enable','region','ambience','weather','phase','setMix','step','event','speak','transport','visibility','close'])assert.equal(typeof audio[name],'function',name);
