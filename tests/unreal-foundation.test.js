...
test('migration integrity manifest tracks all 118 applied sources and preserves Unreal + AI Council foundations',()=>{
 ...
 for(const name of [
  'ai_council_core_v1',
  'ai_council_reviewed_run_index_v1',
  'world_unreal_story_state_v1',
  'world_unreal_story_state_privilege_hardening_v1',
