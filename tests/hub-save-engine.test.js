...
test('Hub mission objectives cannot be forged manually',()=>{
 ...
 const unchanged=applyWorldAction(save,{type:'hubDistrictVisit',id:'commerce'});
 assert.equal(unchanged.hub.missions.first_echo.completedObjectives,0);
});
