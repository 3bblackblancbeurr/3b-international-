...
test('Edge Function JWT classifications keep private/public boundaries explicit',()=>{
  const bySlug=Object.fromEntries(manifest.functions.map(fn=>[fn.slug,fn]));
  for(const slug of ['world-engine','world-bootstrap','city-3b','card-arena','marketplace-3b','delete-account','member-api','ecosystem-private']){
