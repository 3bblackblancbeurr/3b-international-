...
async function snapshot(uid:string){
 ...
 api('/rest/v1/member_profiles?user_id=eq.'+uid+'&select=user_id,handle,name,country,xp,points,theme,created_at,passport_public_id,passport_issued_at,passport_version,passport_state,public_badge_key,public_title,public_verified'),
