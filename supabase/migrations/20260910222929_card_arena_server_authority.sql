...
declare m public.card_arena_matches; r public.card_arena_rooms; player uuid; victory boolean; xp integer; c text; prof public.card_arena_profiles; v_champion uuid; finalists uuid[]; d1 jsonb; d2 jsonb;
begin
 perform pg_advisory_xact_lock(733303);
