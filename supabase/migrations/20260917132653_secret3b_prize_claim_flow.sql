...
revoke all on table public.secret3b_claim_rate_limits from anon, authenticated;
...
revoke all on function public.secret3b_claim_phone_prize(text,text,uuid,text,text,text,text,text,text,text) from public, anon, authenticated;
grant execute on function public.secret3b_claim_phone_prize(text,text,uuid,text,text,text,text,text,text,text) to service_role;
