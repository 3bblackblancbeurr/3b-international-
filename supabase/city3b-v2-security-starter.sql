-- Ville 3B V2 security/starter follow-up. Applied to project ttvhcezucsbbmnafrotq on 2026-09-17.
-- The new city creator preserves the historical 500 Coins starter grant exactly once,
-- while old direct Nexus mutation RPCs are service-role only.
...
begin
 ...
 if starter_ledger_id is not null then perform public.threeb_wallet_apply_server(p_user,0,500); end if;
 return cid;
end $$;
