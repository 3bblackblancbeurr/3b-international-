...
const files=['rules.js','catalog.js','chapters.js','adventure-state.js','avatar-rules.js','settlements.js','wardrobe.js','cards-source.json'].map(name=>({name,content:fs.readFileSync('src/world/'+name,'utf8').replace(/^\uFEFF/,'')}));
